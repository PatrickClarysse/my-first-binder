...
#im1 = double(imread('../Data/HorizontalProfile.png'));
#im2 = double(imread('../Data/HorizontalProfileShifted.png'));

[dx,dy] = size(im1)

# Compute motion components
[u,v]=hsf(im1,im2,lambda,nbiter);
...
imagesc(im1);
hold on
quiver(5:5:dy-5,dx-5:-5:5,u(dx-5:-5:5,5:5:dy-5),v(dx-5:-5:5,5:5:dy-5),'y');
